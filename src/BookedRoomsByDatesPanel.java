 ...
 *
 */
public class BookedRoomsByDatesPanel extends JPanel implements ChangeListener{
	...
	public BookedRoomsByDatesPanel(BookedRoomsByDatesModel reservationsByRoomModel, ArrayList<Room> rooms){
